...
import 'package:cabme_driver/controller/available_jobs_controller.dart';
...
class AvailableJobsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetX<AvailableJobsController>(
      init: AvailableJobsController(),
      builder: (controller) {
        return Scaffold(
                  ...
                  Expanded(
                    child: controller.isLoading.value
                        ...
                        : controller.rideList.isEmpty
                            // TODO i18n
                            ? Constant.emptyView('There are not new rides to take')
                            : ListView.builder(
  ...
  Widget newRideWidgets(BuildContext context, RideData data, AvailableJobsController controller) {
    return InkWell(
      onTap: () async {
  ...
  buildShowBottomSheet(BuildContext context, RideData data, AvailableJobsController controller) {
