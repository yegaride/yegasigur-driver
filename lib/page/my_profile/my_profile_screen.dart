                                        ...
                                        Expanded(
                                          child: ButtonThem.buildButton(
                                            ...
                                            onPress: () {
                                              myProfileController
                                                  .deleteAccount(
                                                myProfileController.userID.toString(),
                                              )
                                                  .then((value) {
                                                if (value != null) {
                                                  if (value["success"] == "success") {
                        ...
                        title: InkWell(
                          onTap: () {
                            myProfileController.selectedCategory.value =
                                myProfileController.vehicleCategoryList[index].libelle.toString();
                            myProfileController.selectedCategoryID.value =
                                myProfileController.vehicleCategoryList[index].id.toString();
