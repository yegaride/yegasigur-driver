                  ...
                  child: Padding(
                    ...
                    child: controller.isLoading.value
                        ...
                        : controller.rideList.isEmpty
                            ? Constant.emptyView(
                                "Your don't have any Withdrawals request".tr,
                              )
                            : ListView.builder(
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(
                                                          Constant().amountShow(
                                                            amount: controller.rideList[index].amount.toString(),
                                                          ),
                                                          style: TextStyle(
                                                            color: controller.rideList[index].statut.toString() == "success"
                                                                ? Colors.green
                                                                : Colors.red,
                                                            fontSize: 16,
                                                            letterSpacing: 1.5,
